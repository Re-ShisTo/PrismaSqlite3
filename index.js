...
const { PrismaMariaDB, PrismaMariaDb } = require("@prisma/adapter-mariadb");
const adapter = new PrismaMariaDb({
  // connectionStrings: "mysql://root:%23CP77%237053R%23@localhost:3306/prisma2",
